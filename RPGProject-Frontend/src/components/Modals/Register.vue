      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="form-group">
            ...
            <div v-if="errors.confirmPassword" class="error-message">{{ errors.confirmPassword[0] }}</div>
          </div>
          <div class="form-actions">
            ...
            <button type="button" class="btn btn-secondary" @click="$emit('close')" :disabled="isLoading">Close</button>
          </div>
        </form>
      </div>
    </div>
...
const handleSubmit = async () => {
  if (password.value !== confirmPassword.value) {
    ...
    emit('register-error', errors.value)
    return
  }
  ...
  try {
    ...
    emit('register-success', 'Registration successful')
